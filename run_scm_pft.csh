...
#######  BEGIN USER DEFINED SETTINGS
  ...
  setenv casename sgp_v2

  # Set the case directory here
  setenv casedirectory $CSCRATCH/SCM_clasp4output

  # Directory where code lives
  setenv code_dir $HOME/e3sm_v2

  # Code tag name 
  setenv code_tag e3sm_clasp_4output
...
# Case specific information kept here
  ...
  set do_iop_srf_prop = .false. # .true. # Use surface fluxes in IOP file?
  set srf_flux_avg = 1  # If ELM surface fluxes used, turn on adjustment of the surface fluxes to reduce instabilities in the surface layer -default 0
  ...
  set iop_file = iop_2015-05-31.nc #IOP file name
# End Case specific stuff here

  # Location of IOP file
  set iop_path = /global/homes/m/meng/scratch/SCM_clasp/input/iop_original   # atm/cam/scam/iop
  ...
  set case_run_dir     = $run_root_dir/run_ctl
...
cat <<EOF >> user_nl_${atm_mod}
 ...
 scmlat = $lat 
 scmlon = $lon
 fincl1 = 'RHW', 'RHI', 'T', 'RHREFHT', 'RELVARC', 'RELVAR', 'RHO_CLUBB', 'WP2_CLUBB', 'UP2_CLUBB', 'VP2_CLUBB', 'UPWP_CLUBB', 'VPWP_CLUBB', 'WP3_CLUBB', 'WPTHLP_CLUBB', 'WPRTP_CLUBB', 'RTP2_CLUBB', 'THLP2_CLUBB', 'RTPTHLP_CLUBB', 'RCM_CLUBB', 'WPRCP_CLUBB', 'CLOUDFRAC_CLUBB', 'CLOUDCOVER_CLUBB', 'WPTHVP_CLUBB', 'ZT_CLUBB', 'ZM_CLUBB', 'UM_CLUBB', 'VM_CLUBB', 'THETAL', 'QT', 'RVMTEND_CLUBB', 'RCMTEND_CLUBB', 'RIMTEND_CLUBB', 'TTEND_CLUBB', 'UTEND_CLUBB', 'VTEND_CLUBB', 'WPRTP2_CLUBB', 'WPTHLP2_CLUBB', 'WP2RTP_CLUBB', 'WP2THLP_CLUBB', 'WPRTPTHLP_CLUBB', 'PRAO', 'PRCO', 'QCSEVAP', 'EVAPPREC', 'CLDICE', 'WP4_CLUBB', 'WPRTP2_ZM_CLUBB', 'WPTHLP2_ZM_CLUBB', 'WP2RTP_ZM_CLUBB', 'WP2THLP_ZM_CLUBB', 'WPRTPTHLP_ZM_CLUBB', 'SL', 'CONCLD', 'WPTHVP_CLUBB2', 'WP2THVP_CLUBB', 'RTPTHVP_CLUBB', 'THLPTHVP_CLUBB', 'WP2RCP_CLUBB', 'RTPRCP_CLUBB', 'THLPRCP_CLUBB', 'RCP2_CLUBB', 'Skw_velocity_CLUBB', 'RTP3_CLUBB', 'THLP3_CLUBB', 'SKW_ZM_CLUBB', 'SKW_ZT_CLUBB'
EOF
...
# ELM namelist options
cat <<EOF >> user_nl_elm
  hist_empty_htapes = .true.
  hist_fincl1 = 'zeta_patch', 'Q2M', 'TSA', 'TAUX', 'TAUY', 'Qh', 'Qle', 'FV', 'FIRE', 'TBOT', 'QBOT', 'RHO', 'PSurf'
  hist_fincl2 = 'zeta_patch', 'Q2M', 'TSA', 'TAUX', 'TAUY', 'Qh', 'Qle', 'FV', 'FIRE', 'TBOT', 'QBOT', 'RHO', 'PSurf'
  hist_nhtfrq = 1, 1
  hist_mfilt  = 10000, 10000
  hist_dov2xy = .false., .true.
  hist_type1d_pertape = ' ', ' '
  finidat = '/global/homes/m/meng/scratch/SCM_clasp/input/surface_data/spinup.elm.r.2014-01-01-00000_no_pftweights.nc'
  fsurdat = '/global/homes/m/meng/scratch/SCM_clasp/input/surface_data/surfdata_ne4np4_simyr2000_c160614_arm_nourban.nc'
EOF
